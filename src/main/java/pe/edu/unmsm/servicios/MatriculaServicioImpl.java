...
public class MatriculaServicioImpl implements IMatriculaServicio {
	...
	public List<Matricula> findAll() {
		...
		//return alumnos.stream().map(p -> new Matricula(p, 1, "PCS", 2, 3.0)).collect(Collectors.toList());
		return matriculas;
	}
	...
	public Matricula findById(Integer id, Integer matricula) {
		...
		Alumno alumno = clienteRest.getForObject("http://localhost:9090/ver/{id}", Alumno.class);
